        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            <div className="bg-primary/90 backdrop-blur-sm px-12 py-8 rounded-lg shadow-2xl">
              <div className="text-5xl md:text-6xl font-bold text-white mb-2" style={{ textShadow: '0 0 20px rgba(255, 255, 255, 0.6)' }}>€43,000</div>
      ...
      <section className="py-20 px-4 md:px-8 bg-gradient-to-b from-white to-light">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              <div className="text-5xl font-bold text-primary mb-2">€43,000</div>
            ...
            >
              <div className="text-5xl font-bold text-secondary mb-2">€17,000</div>
              <div className="text-gray-600 mb-4">Profit per Unit</div>
              <div className="text-sm text-gray-500">50/50 split • €8,500 each</div>
            </motion.div>
          ...
          >
            ...
            <div className="mt-8 grid md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-accent to-secondary p-8 rounded-xl text-white text-center">
                <div className="text-4xl font-bold mb-2">€17,000</div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border-2 border-white/30">
                ...
                <div className="space-y-3 text-white">
                  <div className="flex justify-between text-lg">
                    ...
                    <span className="font-bold">€2,150,000</span>
                  </div>
                  <div className="flex justify-between text-lg">
                  ...
                  <div className="border-t-2 border-white/30 pt-3 mt-3">
                    <div className="flex justify-between text-2xl">
                      ...
                      <span className="font-bold text-accent">€425,000</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/20 backdrop-blur-sm p-8 rounded-xl border-2 border-accent">
                ...
                <div className="space-y-3 text-white">
                  <div className="flex justify-between text-lg">
                    <span>Total Revenue:</span>
                    <span className="font-bold">€3,010,000</span>
                  </div>
                  <div className="flex justify-between text-lg">
                    <span>Total Profit:</span>
                    <span className="font-bold">€1,190,000</span>
                  </div>
                  <div className="border-t-2 border-white/30 pt-3 mt-3">
                    <div className="flex justify-between text-2xl">
                      <span className="font-bold">Your Share:</span>
                      <span className="font-bold text-accent">€595,000</span>
                    </div>
                  </div>
                </div>
              </div>
